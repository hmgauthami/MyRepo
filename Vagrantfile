...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "gauthamit-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/hm_gauthami"
  #   chef.validation_client_name = "hm_gauthami-validator"
  #   chef.validation_key_path = ".chef/hm_gauthami-validator.pem"
  # end
end
